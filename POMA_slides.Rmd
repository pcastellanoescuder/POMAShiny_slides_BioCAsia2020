...
.font110[
  - POMAShiny is a web-app tool powered by Shiny framework and POMA Bioconductor package
  ]
  
.font110[
  - POMAShiny provides several statistical methods for mass spectrometry statistical analysis in a comfortable, interactive and user-friendly environment 
  ]
  
.font110[
  - POMAShiny allows users to include different covariates in the analysis
  ]

.font110[  
  - The joint existence of both POMA package and POMAShiny web interface becomes a huge increase in the reproducibility and transparency of the analysis
  ]
  
.font110[
  - POMAShiny and POMA are both open source projects and everybody is welcome to contribute!
  ]
